...
figure
hold on
plot(Houghton2017(:,1),Houghton2017(:,2).*d,'Color',colorVec(1,:),'linewidth',4)
plot(Hansis2015_I(:,1),Hansis2015_I(:,2).*d,'Color',colorVec(2,:),'linewidth',4)
...
legend('H&N','BLUE','constant','GCP','CABLE','CABLE high','LPX-Bern HYDE',...
