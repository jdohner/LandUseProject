...
if strcmp(vary,'A')
    numCases = 13;
elseif strcmp(vary,'B')
    numCases = 10;
elseif strcmp(vary,'C')
    numCases = 4;
elseif strcmp(vary, 'D')
    numCases = 2;
elseif strcmp(vary,'E')
    numCases = 2;
elseif strcmp(vary,'F')
    numCases = 6;
elseif strcmp(vary,'G')
    numCases = 3;
else % see above for cases
    numCases = 1;
    LU_i = 1;
    opt_i = 1;
    Tdata_i = 1;
...
% non-integer values are for keeping track of cases outside of script 
% (i.e. CLM-V style)
...
% optimization period
% 1 (a) = 1900-2010.5 (can't go past 5 years before end of data)
% 2 (b) = 1900-2005.5
% 3 (c) = 1950-1980
% 4 (d) = 1900-2000.5 % should theoretically match output from end_year
% = 2005.5 in old code

% temperature record
% 1 (I) = HadCRUT4_2018_05
%   Combined land [CRUTEM4] and marine [SST anomalies from HadSST3] 
%   temperature anomalies on a 5° by 5° grid (Morice et al., 2012)
%
% 2 (II) = CRUTEM4_2018_05
...
%   N/A
%
% 6 (VI) = Global Historical Climate Network 
%   N/A
% 
% 7 (VII) = MLOST 3.5 from NOAA
%   Currently unable to access data
%   N/A
%
% 8 (VIII) = temp record from LR/my attempts to match LR (use for debugging)
