...
% for ensembles, no varying other
...
scheme = 'aa';
tempDep_i = 1;
LU_i = 1; % 1 for H&N2017, 2 for BLUE, 3 for const
varSST_i = 1; % 1 for constant SST
BLUE_i = 1;
...
% line here about calling j from vectors of sources/sinks
